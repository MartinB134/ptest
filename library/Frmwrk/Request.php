...
/**
 * Request Class - based on Zend_Controller_Request_Http
 *
 * @package    Frmwrk
...
class Request
{
     ...
     * <img src="<?=$basePath?>/images/Netzelf.png"/>
     *
     * @return string
     */
    ...
    public function getParam($key, $default = null)
    {
        ...
        } elseif ((isset($_SESSION)) && (is_array($_SESSION)) && (array_key_exists('POSTVARS', $_SESSION)) && (is_array($_SESSION['POSTVARS'])) && (array_key_exists($keyName, $_SESSION['POSTVARS']))) {
            return $_SESSION['POSTVARS'][$keyName];
        }
    ...
    public function getParams()
    {
        ...
        if ((isset($_SESSION))
            && (is_array($_SESSION))
            && (array_key_exists('POSTVARS', $_SESSION))
            && (is_array($_SESSION['POSTVARS'])))
        {
            $return += $_SESSION['POSTVARS'];
        }
        return $return;
    }
    ...
    /**
     * Is the request a JSON-request?
     *
     * Tested with mootools only
     *
     * @return boolean
     */
    ...
    {
        return (
            stripos($this->getHeader('Accept'), 'json') !== false ||
            strtolower($this->getHeader('X-Request')) == 'json'
        );
    }
